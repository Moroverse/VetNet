...
// Created by Daniel Moro on 2025-08-02 05:51 GMT.
...
struct SwiftDataPatientRepositoryTests {
    ...
    @MainActor
    func entityToDomainMapping() throws {
        // Given
    ...
    @MainActor
    func invalidDataMapping() throws {
    ...
    @MainActor
    func updatePatient() async throws {
        // Given
        let repository = try createTestRepository()
        let patient = createTestPatient()
    ...
    @MainActor
    func medicalIDUniqueness() async throws {
        // Given
        let repository = try createTestRepository()
    ...
    @MainActor
    func paginationWithoutLimit() async throws {
        // Given
        let repository = try createTestRepository()
        for i in 1 ... 5 {
    ...
    @MainActor
    func cloudKitZoneConfiguration() throws {
        // Given
        let patient = createTestPatient()
    ...
    @MainActor
    func defaultCloudKitZone() throws {
        // Given
        let patient = createTestPatient()
