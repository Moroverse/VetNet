...
// VetNet Patient Domain Model Tests
...
struct PatientDomainTests {
    ...
    func testAgeCalculationSameDay() {
        let patient = Patient(
            name: "Newborn",
            species: .cat,
            breed: .catSiamese,
    ...
    func testPatientIDInvalidString() {
