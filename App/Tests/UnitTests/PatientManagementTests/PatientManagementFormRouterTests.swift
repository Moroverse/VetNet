...
// VetNet Patient Management Form Router Tests
...
struct PatientManagementFormRouterTests {
    ...
    func testCreatePatientFormPresentation() async {
    ...
    func testEditPatientFormPresentation() async {
        let router = PatientManagementFormRouter()
    ...
    func testFormCancellation() async {
        let router = PatientManagementFormRouter()
    ...
    func testMultipleNavigationSteps() {
        let router = PatientManagementFormRouter()
    ...
    func testConcurrentFormPresentations() async {
        let router = PatientManagementFormRouter()
        let patient = createTestPatient()
    ...
    func testRouterFactoryRegistration() {
