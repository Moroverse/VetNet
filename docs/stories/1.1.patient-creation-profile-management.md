...
- [ ] **Task 1: Project Structure & Infrastructure Setup** (AC: 4)
  - [ ] Create modular project structure using Tuist configuration [Source: architecture/01-modular-design.md#feature-module-structure]
  - [ ] Set up Swift 6.2+ with proper concurrency settings (SWIFT_DEFAULT_ACTOR_ISOLATION: "MainActor") [Source: architecture/10-coding-standards.md#swift-concurrency-configuration]
  - [ ] Configure FactoryKit dependency injection container [Source: architecture/swift-best-practices.md#factorykit-dependency-injection]
  - [ ] Integrate SwiftUIRouting module from `Modules/SwiftUIRouting/` [Source: architecture/02-tech-stack.md#custom-dependencies]
  - [ ] Set up Liquid Glass design system components [Source: architecture/02-tech-stack.md#design-system]
...
- [ ] **Task 4: QuickForm UI Implementation** (AC: 1)
  ...
  - [ ] Implement reactive field relationships (species → breed filtering) [Source: architecture/swift-best-practices.md#quickform-usage]
