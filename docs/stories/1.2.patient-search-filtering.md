...
- `App/Sources/Features/PatientManagement/Presentation/Views/BasicList.swift` - Updated to support SearchScopeListModel generic
- `App/Tests/IntegrationTests/PatientScopedSearchTests.swift` - Expanded with tests for all scope types
